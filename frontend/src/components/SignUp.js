...
export default function SignUp() {
    ...
    const continueWithGoogle = (credentialResponse) => {
        console.log(credentialResponse); // Log the full response for debugging
        ...
        fetch("http://localhost:5000/googleLogin", {
            ...
            body: JSON.stringify({
                name: jwtDetail.name,
                userName: jwtDetail.sub, // Use a unique identifier for username
        ...
        .catch((err) => {
            console.error("Error in continueWithGoogle:", err);
